...
| 4.12 24-hour disablement window, complete evidence path | yes (`be91d3e`) | yes (domain, application, golden case; `disablement-window-journey` on the compiled worker: PASS and Inconclusive cases) | passed in the hosted browser job of `34298099868` | no | no |
