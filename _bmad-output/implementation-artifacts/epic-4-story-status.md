...
gate `34224743734` (passed). CI on the current candidate `6237c4c` is `34298099868` (all five jobs green); the live run `34299424112` on `07f79e2` passed the policy-bound audit, the undefined-privilege negative case and the isolation gate. The final candidate `9da4df6` (the hero-workflow merge) has its own green CI `34316930519` and its own passing live run `34317015975` (artifact `10090483703`).
