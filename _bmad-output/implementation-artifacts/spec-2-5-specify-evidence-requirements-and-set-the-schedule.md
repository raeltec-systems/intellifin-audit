...
## Deferred audit resolution — 2026-09-05

The older-editor concurrency audit was completed in Stories 2.6–2.7. The historical deferred entry above is retained to explain the review decision; it is no longer outstanding. Earlier forms now use the shared value/token reconciliation machine and block unknown save outcomes. Story 2.7 added browser proof for Population Source, Target System and Audit Instruction dirty values, conflict reset and committed-response loss, plus submission gating across every editor. The final Story 2.7 suite passed 1,922 unit, 192 integration and 95 browser tests at commit `73d577a6fd0eba73f4b07cc71013d313675dd655`. See [Story 2.7 result](spec-2-7-submit-for-approval-and-approve-or-reject-with-a-diff.md) and [acceptance matrix](review-2-7-matrix.md).
