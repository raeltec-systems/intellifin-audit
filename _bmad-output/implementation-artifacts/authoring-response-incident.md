...
First pushed checkpoint: `9f31558fe74e062aa545a6a938794bf98dc71357`, tree `9102a6fa858bdc2b3172ac5aaa9c9d6e32c7f5f5` (the exact tree of local tested `a8d62c47d1caabbb40f935fbcbe599f6730e7759`), PR #33. Review of the real browser preload found its existing failure case returns HTTP 503; the next focused correction makes that assertion expect the new unavailable-provider message while retaining the manual-save, no-acceptance and unchanged-procedure checks. This is the intended message change, not a relaxed failure assertion. The final CI SHA/results supersede the first run and are recorded in PR #33.
