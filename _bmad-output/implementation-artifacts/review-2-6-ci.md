...
Remote CI is rerun after the repair commit is pushed. The final epic report must record its actual outcome rather than infer container success from local checks.
