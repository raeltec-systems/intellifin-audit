...
const recordSchema = z.strictObject({ requestId: z.uuid(), procedureId: z.uuid(), versionId: z.uuid(), actorId: z.string().min(1).max(200),
  ...
  identity: z.strictObject({ provider: z.literal(AUTHORING_IDENTITY.provider), modelId: z.literal(AUTHORING_IDENTITY.modelId), promptVersion: z.enum(['guided-prose-v1', 'guided-test-design-v2', 'guided-dialogue-v3', AUTHORING_IDENTITY.promptVersion]) }),
