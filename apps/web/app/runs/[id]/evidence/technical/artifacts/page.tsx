...
export const metadata: Metadata = { title: 'Run · Evidence artifacts · IntelliFin Audit' };
 ...
 */
export default async function RunEvidenceArtifactsPage({
  params,
  searchParams,
}: {
            ...
            {observations.rows.map((observation) => (
              <GroundingInspector
                ...
                mediaTypes.get(evidenceId) === 'application/vnd.intellifin.web-tree+json'
                  ...
                  : `/runs/${run.runId}/evidence/technical#evidence-${evidenceId}`}
