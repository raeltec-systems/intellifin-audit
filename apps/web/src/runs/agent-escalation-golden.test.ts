...
import type { EscalationWait } from '@intellifin/application';
...
const wait: EscalationWait = { runId: '019823ab-0000-7000-8000-000000000001', waitId: '019823ab-0000-7000-8000-000000000002',
  kind: 'retry-or-skip', options: [{ id: 'retry', label: 'Retry' }, { id: 'skip', label: 'Skip' }],
  openedAt: '2026-09-06T09:00:00.000Z', openedBy: null,
